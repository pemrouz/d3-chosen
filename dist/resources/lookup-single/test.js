...
var _lookupSingle = require('./lookup-single');

var _lookupSingle2 = _interopRequireDefault(_lookupSingle);
...
once(document.head)('style', 1).html((0, _cssscope2.default)(file(__dirname + '/lookup-single.css'), 'lookup-single'));

test('basic output', function (t) {
  t.plan(1);

  var host = o('lookup-single', 1).node();
  _lookupSingle2.default.call(host, { options: ['foo'] });
...
//       , host  = tdraw(o('lookup-single', 1), lookup, state)
